...
public class LoginServlet extends HttpServlet {
	...
	private void sendToBannPage(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
	...
	private void successLogin(HttpServletRequest request,
	...
	private void failLogin(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
