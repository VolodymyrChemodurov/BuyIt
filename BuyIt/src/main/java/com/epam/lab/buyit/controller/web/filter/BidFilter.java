...
public class BidFilter implements Filter {
	private static final Logger LOGGER = Logger.getLogger(BidFilter.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (httpRequest.getParameter("bid") == null)
			parameterNotFound("Bid parameter not found in request", httpRequest, httpResponse);
