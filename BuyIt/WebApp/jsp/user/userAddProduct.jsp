		...
		<div id="maWrapper" class="corAll5">
			...
			<div style="overflow: hidden;">
				...
				<div id="maContent" class="corAll5">
					<form id="form-new-product" action="userAddProductServlet"
							...
							<div id="right-menu" class="my-right-content"
								...
								<div id="form-container" style="padding-top: 40px">
									...
									<div id="errorDiv" class="alert alert-error"
										style="display: none; margin-right: 49px; margin-top: 8px; border-radius: 0 0 0 0; font-size: 14px;"d"></div>
						...
						<div id="submitButtonWrapper">
							...
							<button type="button" disabled="disabled"
								id="addProductSubmitButton" onclick="validateFormOnSubmit()"
								class="btn btn-success">Create Auction</button>
						</div>
					</form>
				</div>
				<!-- /maContent -->
