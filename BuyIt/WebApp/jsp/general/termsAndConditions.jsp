		...
		<div class="span11">
			...
			<div class="span5">
				...
				<p>Please read these Terms and Conditions ("Agreement", "Terms
					and Conditions") carefully before using http://localhost:8080/BuyIt
					("the Site") operated by EPAM Lab ("us", "we", or "our"). This
					Agreement sets forth the legally binding terms and conditions for
					your use of the Site at http://localhost:8080/BuyIt.</p>
				<p>By accessing or using the Site in any manner, including, but
					...
					these Terms and Conditions. Capitalized terms are defined in this
					Agreement.</p>

				<p>
					<strong>Intellectual Property</strong><br />The Site and its
					original content, features and functionality are owned by EPAM Lab
				...
				<p>
					...
					the Site, without cause or notice, which may result in the
				...
				<p>
					...
					links to third-party sites that are not owned or controlled by EPAM
					Lab.
				</p>
				<p>EPAM Lab has no control over, and assumes no responsibility
				...
				<p>
					<strong>Governing Law</strong><br />This Agreement (and any
					further rules, polices, or guidelines incorporated by reference)
					shall be governed and construed in accordance with the laws of
					Lviv, Ukraine, without giving effect to any principles of conflicts
					of law.
				</p>
				...
				<p>
					...
					use of the Site after any such changes constitutes your acceptance
				...
				<p style="font-size: 85%; color: #999;">
					Published and generated with permission from <a
						href="http://termsfeed.com/terms-conditions/generator/"
						style="color: #999; text-decoration: none;">www.termsfeed.com</a>.
				</p>
